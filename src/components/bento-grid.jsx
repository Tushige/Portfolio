...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl overflow-hidden group/bento shadow-md hover:shadow-xl transition duration-200 shadow-inputbg-fuchsia-100/20 border border-transparent justify-start flex flex-col",
